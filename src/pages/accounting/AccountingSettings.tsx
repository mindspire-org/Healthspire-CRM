        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div>
              ...
              <Input value={settings?.cashAccount||""} onChange={(e)=>set("cashAccount", e.target.value)} />
            </div>
            <div>
            ...
            <div>
              ...
              <Input value={settings?.revenueAccount||""} onChange={(e)=>set("revenueAccount", e.target.value)} />
            </div>
            <div>
              <Label>AR Parent</Label>
              <Input value={settings?.arParent||""} onChange={(e)=>set("arParent", e.target.value)} />
            </div>
            <div>
              <Label>AP Parent</Label>
              <Input value={settings?.apParent||""} onChange={(e)=>set("apParent", e.target.value)} />
            </div>
            <div>
              <Label>Salary Expense</Label>
              <Input value={settings?.salaryExpense||""} onChange={(e)=>set("salaryExpense", e.target.value)} />
            </div>
            <div>
              <Label>Salary Payable Parent</Label>
              <Input value={settings?.salaryPayableParent||""} onChange={(e)=>set("salaryPayableParent", e.target.value)} />
            </div>
            <div>
              <Label>Base Currency</Label>
              <Input value={settings?.baseCurrency||"PKR"} onChange={(e)=>set("baseCurrency", e.target.value)} />
            </div>
            <div>
          ...
          <div className="flex justify-end gap-2">
            <Button onClick={load} variant="secondary" disabled={busy}>Reload</Button>
