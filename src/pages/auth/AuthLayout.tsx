...
export default function AuthLayout() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-[radial-gradient(1000px_circle_at_15%_20%,rgba(99,102,241,0.18),transparent_55%),radial-gradient(900px_circle_at_85%_25%,rgba(14,165,233,0.16),transparent_55%),radial-gradient(900px_circle_at_50%_90%,rgba(34,197,94,0.10),transparent_60%)] bg-gradient-to-br from-slate-950 via-slate-950 to-indigo-950 flex items-center justify-center p-4">
              ...
              <Card className="shadow-2xl border border-white/10 bg-white/10 backdrop-blur-xl">
                ...
                <CardContent className="pt-0">
                  <Tabs defaultValue="team" className="w-full">
                    <TabsList className="w-full grid grid-cols-2 mb-6 bg-white/5">
